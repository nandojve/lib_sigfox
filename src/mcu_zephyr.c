...
LOG_MODULE_REGISTER(sigfox_mcu, CONFIG_SIGFOX_LOG_LEVEL);

#define SIGFOX_MCU_API_VERSION	"v2.3.7"
...
sfx_u8 MCU_API_get_version(sfx_u8 **version, sfx_u8 *size)
{
	...
	(*size) = sizeof(SIGFOX_MCU_API_VERSION);
